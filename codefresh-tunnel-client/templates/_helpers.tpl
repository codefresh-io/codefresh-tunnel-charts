...
*/}}
{{- define "codefresh-tunnel-server.chart" -}}
...
helm.sh/chart: {{ include "codefresh-tunnel-server.chart" . }}
{{ include "codefresh-tunnel-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "codefresh-tunnel-server.name" . }}
